...
ActiveRecord::Schema.define(version: 20150607212609) do
  ...
  add_index "project_types", ["project_id"], name: "index_project_types_on_project_id", using: :btree
  add_index "project_types", ["type_id"], name: "index_project_types_on_type_id", using: :btree
  ...
  add_foreign_key "project_types", "types"
end
